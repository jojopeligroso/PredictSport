-- Add 'exact_score' prediction type to all CHECK constraints
...
alter table public.event_prediction_types
  ...
  check (prediction_type in ('winner', 'top_n', 'final_standings', 'head_to_head', 'margin', 'over_under', 'handicap', 'yes_no', 'progression', 'exact_score'));
...
alter table public.event_nominations
  ...
  check (proposed_prediction_type in ('winner', 'top_n', 'final_standings', 'head_to_head', 'margin', 'over_under', 'handicap', 'yes_no', 'progression', 'exact_score'));
