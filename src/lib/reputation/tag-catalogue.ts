...
const theProfessor: TagDefinition = {
  ...
  category: "event_driven",
  priorityTier: 2,
  metric: "exact_score_streak",
  qualifies: eventNoOp,
  zScore: eventZScoreNoOp,
  layer1: "The Professor",
  layer2: "Two exact scores in a row. You have done the reading.",
  layer3: "{name} has nailed two exact scores in a row. The Professor.",
  factCard: {
    fact: "Consecutive exact score predictions correct.",
    statTemplate: "{stat} exact in a row",
    contextTemplate: "Most in group: {contextStat}",
  },
  visual: { borderColor: "#f59e0b", gold: true },
  rejectable: false,
  announced: true,
