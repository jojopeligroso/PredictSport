 ...
 *
 * Vercel cron — runs Sep 1 2026. Sets hidden_at on all WC tournament
 * competitions so the promo card disappears from the dashboard.
 * WC pages remain accessible via direct URL.
 */
